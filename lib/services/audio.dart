...
enum Sfx {
  /// Finger lands on a square.
  cellTap('sfx/select_start.ogg'),

  /// A number was entered and it is consistent with the solution.
  placeGood('sfx/word_found.ogg'),

  /// A number was entered that contradicts the solution. Deliberately a soft
  /// click, not an error buzzer.
  placeWrong('sfx/word_wrong.ogg'),
...
enum Music {
  ...
  gameplayA('music/music_gameplay_a.ogg'),
  gameplayB('music/music_gameplay_b.ogg');
