...
///
/// Derived from a hash of the CALENDAR DATE, so every player in the world gets
...
/// and a well-founded suspicion of anything asking to sign in).
library;
...
class DailyPuzzle {
  /// Stable 31-bit hash of y/m/d. Deliberately hand-rolled: `Object.hash` and
  /// `String.hashCode` are explicitly NOT stable across Dart versions or
  /// platforms, so using either would silently change everyone's puzzle on an
  /// SDK bump.
  ...
  /// Saturday, and Sunday eases off again so a weekly player is not left on a
  /// cliff edge.
