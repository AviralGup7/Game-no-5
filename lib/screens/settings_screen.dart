            ...
            return ListView(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  subtitle:
                      Text('Shade the line you are working in', style: sub()),
                  value: s.highlightLine,
                  onChanged: s.setHighlightLine,
                ),
                SwitchListTile(
                  title: Text('Show mistakes', style: label()),
                  subtitle: Text('Mark a wrong square straight away',
                      style: sub()),
                  value: s.showMistakes,
                  onChanged: s.setShowMistakes,
                ),
                SwitchListTile(
                  title: Text('Cross out finished lines', style: label()),
                  subtitle: Text(
                      'When a line is done, fill in its empty squares for you',
                      style: sub()),
                  value: s.autoCross,
                  onChanged: s.setAutoCross,
                ),
                SwitchListTile(
                ...
                SwitchListTile(
                  ...
                  subtitle:
                      Text('Off unless you turn it on', style: sub()),
                  value: s.music,
                  onChanged: (v) {
                    s.setMusic(v);
                ...
                _stat('Pictures found', '${progress.album.length}', fs),
                ...
                if (progress.album.isNotEmpty) ...[
                  const SizedBox(height: 18),
                  Text('Pictures you have found', style: label()),
                  const SizedBox(height: 8),
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: (progress.album.toList()..sort())
                        .map((n) => Chip(
                              label: Text(n,
