...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    // First run: show how-to-play. Nonogram clue notation is genuinely opaque
    // until someone explains it once, and an unexplained grid of numbers is an
    // immediate uninstall.
  ...
  Widget build(BuildContext context) {
    ...
    final album = widget.progress.album.length;
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            Text(
              'Fill the squares to reveal a picture.',
                  ...
                  children: [
                    ...
                    if (doneToday)
                      ...
                      FilledButton(
                        ...
                        child: Text('Play', style: TextStyle(fontSize: 20 * fs)),
                      ),
                    if (doneToday) ...[
  ...
  Widget _stat(String label, String value, String unit, double fs) => Column(
        ...
        children: [
          Text(value,
              style:
                  TextStyle(fontSize: 28 * fs, fontWeight: FontWeight.w700)),
          Text(label, style: TextStyle(fontSize: 15 * fs)),
          if (unit.isNotEmpty)
